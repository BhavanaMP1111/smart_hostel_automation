# Smart Hostel Automation and Power Monitoring

IoT-based smart hostel automation and power monitoring system developed as part of the **Samsung Innovation Campus (SIC) Capstone Project**.
...
In many hostels, electrical appliances like lights and fans are often left running even when rooms are unoccupied. This leads to unnecessary energy wastage and higher electricity costs. Additionally, there is limited visibility into individual room power usage.
...
* Develop an IoT-based system to control hostel room appliances remotely
...
The implementation of the project is managed using Git for version control. All source code including ESP32 scripts, Raspberry Pi Python scripts, and documentation are maintained in a Git repository for collaboration and version tracking.
...
* Managing real-time data processing at the edge device
...
* Integration of a mobile application for easier control
* AI-based energy consumption analysis
* Addition of smart sensors such as motion and smoke detectors
* Real-time dashboard for power monitoring and visualization
